...
function mapStateToProps ({ questions, users, authedUser }) {
  ...
  let userUnAnswers = []
  Object.keys(questions).sort((a,b) => questions[b].timestamp - questions[a].timestamp).forEach((res, i) => {
  ...
  let userAnswers = Object.keys(userQuestions).sort((a,b) => questions[b].timestamp - questions[a].timestamp).map((res, i) => {
    return [res, userQuestions[res]]
      ...
      return {
        ...
        userAnswers,
        userUnAnswers,
        questionAnswer: Object.keys(questions)
